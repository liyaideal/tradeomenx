-- Fix balance calculation: only completed transactions should be counted
-- Completed deposits: 5000 + 3000 + 8000 = 16,000
-- Completed withdrawals: 1500 + 800 = 2,300
-- Trade P&L: 450 - 320 - 300 = -170
-- Correct balance: 16,000 - 2,300 - 170 = 13,530
...
AS $function$
DECLARE
  -- Balance = completed deposits - completed withdrawals + trade P&L
  -- 16,000 - 2,300 - 170 = 13,530
...
BEGIN
  ...
  -- Completed deposits: 5000 + 3000 + 8000 = 16,000 (credited to balance)
  ...
  -- Processing deposits: NOT included in balance (shown in Pending Confirmations)
  INSERT INTO public.transactions (user_id, type, amount, status, description, network, tx_hash, confirmations, required_confirmations, created_at)
  VALUES
  ...
  -- Completed withdrawals: 1500 + 800 = 2,300 (debited from balance)
  INSERT INTO public.transactions (user_id, type, amount, status, description, network, tx_hash, confirmations, required_confirmations, created_at)
  VALUES
  ...
  -- Failed transaction (not included in balance)
  ...
  -- Trade P&L transactions: 450 - 320 - 300 = -170 (included in balance)
  ...
  -- Mock open positions (option_id NULL to avoid FK constraint)
