-- Fix handle_new_user() to use correct transaction type values
...
BEGIN
  ...
  -- Create demo transactions for new users (using correct type values)
  ...
  VALUES
    ...
    -- Pending withdrawal
    (NEW.id, 'withdraw', 500, 'processing', 'USDT Withdrawal', 'ERC20', NULL, 0, 12, NOW() - INTERVAL '2 hours'),
    -- Trade P&L records
