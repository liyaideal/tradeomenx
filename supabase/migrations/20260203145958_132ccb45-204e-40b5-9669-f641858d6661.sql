-- Add mock trades for settlements display
-- Settlements query: trades with status='Filled' AND closed_at IS NOT NULL
...
BEGIN
  ...
  VALUES
    -- Won trade: Fed Rate Decision (Long at 0.65, settled at 1.00)
    ...
    -- Lost trade: Apple Stock (Long at 0.55, settled at 0.00)
    ...
    -- Won trade: Gold Price (Short at 0.42, settled at 0.00 means short wins)
