...
BEGIN
  ...
  -- Reduce position (take some profit)
  INSERT INTO public.trades (
    user_id, event_name, option_label, side, order_type, price, quantity, amount, margin, fee, status, pnl, leverage, created_at, closed_at
  ) VALUES (
    NEW.id, 'When will government shutdown end?', 'Before Feb 1', 'sell', 'Market', 0.55, 30, 16.5, 0, 0.165, 'Filled', 8, 10, now() - interval '4 days', now() - interval '3 days'
  );
  -- Final add before settlement
  INSERT INTO public.trades (
    user_id, event_name, option_label, side, order_type, price, quantity, amount, margin, fee, status, pnl, leverage, created_at, closed_at
  ) VALUES (
  ...
  -- Reduce - lock in some gains
  INSERT INTO public.trades (
    user_id, event_name, option_label, side, order_type, price, quantity, amount, margin, fee, status, pnl, leverage, created_at, closed_at
  ) VALUES (
    NEW.id, '2024 US Presidential Election Result', 'Trump', 'sell', 'Market', 0.65, 25, 16.25, 0, 0.163, 'Filled', 5, 10, now() - interval '38 days', now() - interval '30 days'
  );
  INSERT INTO public.trades (
    user_id, event_name, option_label, side, order_type, price, quantity, amount, margin, fee, status, pnl, leverage, created_at, closed_at
  ) VALUES (
  ...
  -- Reduce at high point
  INSERT INTO public.trades (
    user_id, event_name, option_label, side, order_type, price, quantity, amount, margin, fee, status, pnl, leverage, created_at, closed_at
  ) VALUES (
    NEW.id, 'Will Bitcoin exceed $100K by end of 2024?', 'Yes', 'sell', 'Market', 0.72, 40, 28.8, 0, 0.288, 'Filled', 12, 10, now() - interval '9 days', now() - interval '7 days'
  );
  INSERT INTO public.trades (
    user_id, event_name, option_label, side, order_type, price, quantity, amount, margin, fee, status, pnl, leverage, created_at, closed_at
  ) VALUES (
  ...
  -- Cut loss - reduce position
  INSERT INTO public.trades (
    user_id, event_name, option_label, side, order_type, price, quantity, amount, margin, fee, status, pnl, leverage, created_at, closed_at
  ) VALUES (
    NEW.id, 'Will OpenAI GPT-5 be released in 2024?', 'Yes', 'sell', 'Market', 0.45, 30, 13.5, 0, 0.135, 'Filled', -5, 10, now() - interval '23 days', now() - interval '20 days'
  );
  INSERT INTO public.trades (
    user_id, event_name, option_label, side, order_type, price, quantity, amount, margin, fee, status, pnl, leverage, created_at, closed_at
  ) VALUES (
  ...
  -- Reduce to secure profit
  INSERT INTO public.trades (
    user_id, event_name, option_label, side, order_type, price, quantity, amount, margin, fee, status, pnl, leverage, created_at, closed_at
  ) VALUES (
    NEW.id, 'Will Tesla stock exceed $250 in Q4?', 'Yes', 'sell', 'Market', 0.75, 20, 15, 0, 0.15, 'Filled', 6, 10, now() - interval '8 days', now() - interval '5 days'
  );
  INSERT INTO public.trades (
    user_id, event_name, option_label, side, order_type, price, quantity, amount, margin, fee, status, pnl, leverage, created_at, closed_at
  ) VALUES (
  ...
  INSERT INTO public.trades (
    ...
    NEW.id, 'Apple Fall Event Date', 'September', 'sell', 'Market', 0.85, 20, 17, 0, 0.17, 'Filled', 4, 10, now() - interval '93 days', now() - interval '90 days'
  );
