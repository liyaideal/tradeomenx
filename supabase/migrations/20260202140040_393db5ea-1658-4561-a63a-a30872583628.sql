-- Fix handle_new_user to properly set initial balance using ON CONFLICT DO UPDATE
...
BEGIN
  ...
  -- Deposits: 5000 + 3000 + 2000 = 10,000
  -- Withdrawals: -2000 - 1500 = -3,500
  -- Trade profits: +850 + 1200 = +2,050
  -- Trade losses: -320
  -- Net = 10,000 - 3,500 + 2,050 - 320 = 8,230
  v_initial_balance := 8230;
  ...
  VALUES
    -- PENDING CONFIRMATIONS (processing status - not yet reflected in balance)
