-- Idempotency + comment cleanup for dual-account core (2a follow-up)
...
-- Refresh handle_new_user: drop misleading "keep demo transaction decorations" comment.
...
BEGIN
  ...
  -- Dual-account model: both spot and futures start at $0. No demo transactions seeded.
