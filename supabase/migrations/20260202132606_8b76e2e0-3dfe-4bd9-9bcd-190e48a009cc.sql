...
-- Fix handle_new_user function - use NULL for option_id to avoid foreign key constraint
...
BEGIN
  ...
  -- Create demo open positions - use NULL for option_id to avoid foreign key issues
