...
export const FloatingDiscordButton = ({ className = "" }: { className?: string }) => {
  ...
  return (
    ...
    >
      {/* Discord icon button */}
      <div className="relative w-11 h-11 rounded-full bg-[#5865F2] shadow-lg shadow-[#5865F2]/30 flex items-center justify-center transition-all duration-300 group-hover:scale-110 group-active:scale-95 animate-[pulse-soft_3s_ease-in-out_infinite]">
