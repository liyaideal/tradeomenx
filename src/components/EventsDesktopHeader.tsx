      ...
      <div className="mx-auto flex w-full max-w-7xl min-w-0 items-center justify-between gap-6 px-4 py-3 lg:px-6">
        ...
        <div className="flex min-w-0 items-center gap-2 xl:gap-4">
          ...
          <a
            ...
            aria-label="Discord"
            className="hidden xl:flex items-center justify-center w-10 h-10 rounded-lg border border-border/50 bg-muted/30 hover:bg-[#5865F2]/15 hover:border-[#5865F2]/40 transition-colors"
          >
